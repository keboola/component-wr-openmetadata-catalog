...
def test_build_dashboard_structured_extension():
    ...
    body = (
        _builder()
        .build_dashboard(config, app_states={"01kp6nkwmg6j45ha4w2z5b99k2": "running"}, synced_at="2026-09-22 10:00 UTC")
        .body
    )
...
def test_owner_email_extracted_from_wrapped_description():
    config = {
        "id": "1",
        "currentVersion": {"creatorToken": {"description": "kbagent-cli [martin.struzsky@keboola.com]"}},
    }
